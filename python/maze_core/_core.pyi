...
class CollidedEntity:
    class Wall(CollidedEntity):
        __match_args__ = ()
        def __new__(cls) -> CollidedEntity.Wall: ...
        def __len__(self) -> builtins.int: ...
        def __getitem__(self, key:builtins.int) -> typing.Any: ...
    
    class Flag(CollidedEntity):
        __match_args__ = ("_0",)
        @property
        def _0(self) -> builtins.int: ...
        def __new__(cls, _0:builtins.int) -> CollidedEntity.Flag: ...
        def __len__(self) -> builtins.int: ...
        def __getitem__(self, key:builtins.int) -> typing.Any: ...
    
    class CapturePoint(CollidedEntity):
        __match_args__ = ("_0",)
        @property
        def _0(self) -> builtins.int: ...
        def __new__(cls, _0:builtins.int) -> CollidedEntity.CapturePoint: ...
        def __len__(self) -> builtins.int: ...
        def __getitem__(self, key:builtins.int) -> typing.Any: ...
    
    class Unknown(CollidedEntity):
        __match_args__ = ("_0",)
        @property
        def _0(self) -> builtins.int: ...
        def __new__(cls, _0:builtins.int) -> CollidedEntity.Unknown: ...
        def __len__(self) -> builtins.int: ...
        def __getitem__(self, key:builtins.int) -> typing.Any: ...
...
class HitInfo:
    ...
    @property
    def hit(self) -> typing.Optional[CollidedEntity]: ...
    @property
